...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($companies as $company) {
            ...
            // Configurar purpose en pipelines y marcar penúltima etapa como pública
            $this->call(PipelinePurposeAndPublicationSeeder::class, false, ['companyId' => $company->id]);
        ...
        // Set Spanish as default language for all companies
        Company::query()->update(['locale' => 'es']);
