...
class PermissionRole extends BaseModel
{
    ...
    public static function employeeRolePermissions()
    {
        ...
        $employeePermissionsArray = [
            ...
            'view_lead' => PermissionType::OWNED,
            ...
            'delete_lead_follow_up' => PermissionType::NONE,

            // Permisos de negocios (deals)
            'add_deals' => PermissionType::ALL,
            'view_deals' => PermissionType::ALL,
            'edit_deals' => PermissionType::ALL,
            'delete_deals' => PermissionType::OWNED,
            'change_deal_stages' => PermissionType::ALL,
            'add_deal_note' => PermissionType::ALL,
            'view_deal_note' => PermissionType::ALL,
            'edit_deal_note' => PermissionType::ALL,
            'delete_deal_note' => PermissionType::NONE,
            ...
            'edit_product' => PermissionType::ALL,
            'delete_product' => PermissionType::ALL,
            'add_product' => PermissionType::ALL,
