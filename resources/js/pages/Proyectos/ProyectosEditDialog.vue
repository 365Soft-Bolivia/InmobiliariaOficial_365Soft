...
const form = useForm({
  ...
  habitaciones: props.product.habitaciones || null,
  banos: props.product.banos || null,
  cocheras: props.product.cocheras || null,
  ano_construccion: props.product.ano_construccion || null,
  operacion: props.product.operacion || 'venta',
  comision: props.product.comision || null,
  taxes: props.product.taxes || null,
  description: props.product.description || '',
  category_id: props.product.category?.id || null,
  sku: props.product.sku || '',
  hsn_sac_code: props.product.hsn_sac_code || '',
  allow_purchase: props.product.allow_purchase ?? true,
  is_public: props.product.is_public ?? true,
  downloadable: props.product.downloadable ?? false,
  downloadable_file: props.product.downloadable_file || '',
  default_image: props.product.default_image || '',
});
  ...
  <Teleport to="body">
    <div class="fixed inset-0 z-[9999] overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      <div class="flex min-h-screen items-end justify-center px-4 pb-20 pt-4 text-center sm:block sm:p-0">
        ...
        >
          <div class="relative inline-block transform overflow-hidden rounded-lg bg-white text-left align-bottom shadow-xl transition-all dark:bg-gray-800 sm:my-8 sm:w-full sm:max-w-3xl sm:align-middle">
            <form @submit.prevent="submit">
                ...
                <div class="mt-6 max-h-[60vh] overflow-y-auto">
                  ...
                  <div v-show="currentTab === 'general'" class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <input
                        v-model="form.codigo_inmueble"
                        type="text"
                        required
                        class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:text-sm"
                      />
                      <p v-if="form.errors.codigo_inmueble" class="mt-1 text-sm text-red-600">{{ form.errors.codigo_inmueble }}</p>
                    </div>
                  ...
                  <div v-show="currentTab === 'detalles'" class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:text-sm"
                      />
                      <p v-if="form.errors.superficie_util" class="mt-1 text-sm text-red-600">{{ form.errors.superficie_util }}</p>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:text-sm"
                      />
                      <p v-if="form.errors.superficie_construida" class="mt-1 text-sm text-red-600">{{ form.errors.superficie_construida }}</p>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:text-sm"
                      />
                      <p v-if="form.errors.habitaciones" class="mt-1 text-sm text-red-600">{{ form.errors.habitaciones }}</p>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                      ...
                      <input
                        v-model.number="form.ano_construccion"
                        type="number"
                        min="1900"
                        :max="new Date().getFullYear()"
                        class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:text-sm"
                      />
                      <p v-if="form.errors.ano_construccion" class="mt-1 text-sm text-red-600">{{ form.errors.ano_construccion }}</p>
                    </div>
                  </div>
                  ...
                  <div v-show="currentTab === 'otros'" class="space-y-4">
                    ...
                    <div class="space-y-3">
                      <div class="flex items-center">
                        <input
                          v-model="form.allow_purchase"
                          type="checkbox"
                          id="edit_allow_purchase"
                          class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                        />
                        <label for="edit_allow_purchase" class="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                          Permitir compra
                        </label>
                      </div>
                      ...
                      <div class="flex items-center">
                        <input
                          ...
                          class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                        />
                        <label for="edit_is_public" class="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                      ...
                      <!-- <div class="flex items-center">
                        <input
                          ...
                          type="checkbox"
                          id="edit_downloadable"
                          class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                        />
                        <label for="edit_downloadable" class="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                          Archivo descargable
                        </label>
                      </div> -->
                    </div>
                    ...
                    <div v-if="form.downloadable">
                      ...
                      <input
                        v-model="form.downloadable_file"
                        type="text"
                        class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:text-sm"
                      />
                      <p v-if="form.errors.downloadable_file" class="mt-1 text-sm text-red-600">{{ form.errors.downloadable_file }}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-gray-50 px-4 py-3 dark:bg-gray-900 sm:flex sm:flex-row-reverse sm:px-6">
                ...
                >
                  <svg v-if="form.processing" class="mr-2 h-4 w-4 animate-spin text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
